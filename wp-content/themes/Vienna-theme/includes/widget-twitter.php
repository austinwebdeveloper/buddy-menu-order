...
class lateset_tweets extends WP_Widget {
	function lateset_tweets() {
		...
		$widget_ops = array('classname' => 'tweets','description' => esc_html__('Twitter Widget - displays Latest Tweets',TEXT_DOMAIN));
/*		$control_ops = array( 'twitter name' => 'pulsar', 'count' => 3, 'avatar_size' => '32' );
*/		
		parent::__construct('latest-tweets',esc_html__('[Micro Themes] - Twitter',TEXT_DOMAIN),$widget_ops);
...
function form( $instance ) {
		...
		$defaults = array( 'title' => esc_html__('Twitter',TEXT_DOMAIN), 
			'twitterWidgetID' => '', 
			'count' => 3,
			'enableLinks' => 0,
			'showUser' => 0,
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'twitterWidgetID' ); ?>"><?php esc_html_e('Twitter Widget ID:', TEXT_DOMAIN); ?> <a href="https://www.pulsarmedia.ca/generating-a-twitter-widget-id/" target="_blank"><?php esc_html_e('More info', TEXT_DOMAIN); ?></a></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id( 'count' ); ?>"><?php esc_html_e('Number of tweets to display:', TEXT_DOMAIN) ?></label>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'enableLinks' ); ?>"><?php esc_html_e('Activate Links?', TEXT_DOMAIN); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showUser' ); ?>"><?php esc_html_e('Display User Thumbnail?', TEXT_DOMAIN); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showTime' ); ?>"><?php esc_html_e('Display time of tweet?', TEXT_DOMAIN); ?></label>  
        </p>
        ...
        <p>  
            ...
            <label for="<?php echo $this->get_field_id( 'showInteraction' ); ?>"><?php esc_html_e('Display Interaction Links?', TEXT_DOMAIN); ?></label>  
        </p>
