	...
	$.fn.init_addon_totals = function() {
		...
		$(this).on( 'woocommerce-product-addons-update', function() {
			...
			if ( total > 0 && qty > 0 ) {
				...
				html = '<dl class="product-addon-totals" data="r"><dt>' + woocommerce_addons_params.i18n_addon_total + '</dt><dd><strong><span class="amount">' + formatted_addon_total + '</span></strong></dd>';
